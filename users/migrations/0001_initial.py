    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, null=True, unique=True, verbose_name='Емейл')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(blank=True, null=True, verbose_name='URL-путь')),
                ...
                ('email', models.EmailField(blank=True, max_length=200, null=True, verbose_name='Емейл')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Company', verbose_name='Компания')),
            ],
        ),
        migrations.CreateModel(
            name='CompanyType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payer_certificates', to='users.Company', verbose_name='Компания')),
            ],
        ),
        migrations.CreateModel(
            name='PayerRegister',
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payer_registers', to='users.Company', verbose_name='Компания')),
            ],
        ),
        migrations.CreateModel(
            name='PhoneNumber',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tax_payers', to='users.Company', verbose_name='Компания')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ukraine_statistics', to='users.Company', verbose_name='Компания')),
            ],
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Увидемления пользователя',
            },
        ),
        migrations.AddField(
